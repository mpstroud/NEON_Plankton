...
data = time_series_all_sites_list[1]
data_v2 = as.data.frame(data)

data_v2 = data_v2 %>%
  select(X06887500.dateTime,X06887500.discharge, X06887500.chl_a)

write.csv(data_v2, "R:/EcosystemEcologyLab/MSAPLANKTONdataDirectory/DataInDevelopment/NEONData/Kansas River_Brunsetal2022/01_input/KansasData.csv")

#I polished the format in excel real quick, need to do it here at some point

```

cQ analysis for chlorophyll & Turbidity/year/site following (Millar et al. 2021)
```{r setup, include=FALSE}
...
input_dir <- "R:/EcosystemEcologyLab/MSAPLANKTONdataDirectory/DataInDevelopment/NEONData/Kansas River_Brunsetal2022/01_input"
output_dir <- "R:/EcosystemEcologyLab/MSAPLANKTONdataDirectory/DataInDevelopment/NEONData/Kansas River_Brunsetal2022"
###################### READ IN FUNCTIONS #
source(file.path("R:/EcosystemEcologyLab/MSAPLANKTONdataDirectory/DataInDevelopment/NEONData/Kansas River_Brunsetal2022/cQ_functions.R"))
...
allInputData30Min <- read.csv(file.path(input_dir,paste("KansasData.csv")))
